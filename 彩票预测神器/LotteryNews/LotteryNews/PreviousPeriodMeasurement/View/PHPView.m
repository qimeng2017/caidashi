...
- (void)customInit{
    ...
    UIView *bView = [[UIView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(centerView.frame), kScreenWidth, 44)];
...
- (void)segmentView:(NSArray *)arr{
    ...
    _segement=[[LiuXSegmentView alloc]initWithFrame:CGRectMake(CGRectGetWidth(_categorySelectBtn.frame), 0, kScreenWidth-CGRectGetWidth(_categorySelectBtn.frame), 44) titles:arr clickBlick:^(NSInteger index) {
        NSLog(@"%ld",(long)index);
