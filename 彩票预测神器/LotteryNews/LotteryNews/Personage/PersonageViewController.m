...
- (void)viewDidLoad {
   ...
   BOOL status = [[NSUserDefaults standardUserDefaults] boolForKey:LOTTORY_REVIEW_STATUS];
    if (status) {
        ...
        self.titleItems = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"NotThroughAudit" ofType:@"plist"]];
    }
